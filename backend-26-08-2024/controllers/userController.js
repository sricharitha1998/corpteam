...
const url = `https://pms.corpteamsolution.com/login`                            
let HtmlMsg = `<div><p><b>Service partner account is created successfully.</b> <br /> Check the below credentials: <br /> <b>Username:</b> ${req.body.username} <br/> <b>Email:</b> ${req.body.email} <br /> <b>Password:</b>  ${req.body.password} <a href=${url}>Click here to login</a></p></div>`;
