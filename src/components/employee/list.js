        ...
        <div className="container-fluid">
          ...
          <div className="row page-titles">
            <ol className="breadcrumb">
              <li className="breadcrumb-item active"> List Employees</li>
            </ol>
          </div>
          <div className="row page-titles">
                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Employee ID <FontAwesomeIcon icon={sortOrder === 'asc' ? faAngleUp : faAngleDown} onClick={handleSort} /></th>
