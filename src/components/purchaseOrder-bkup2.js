...
function PurchaseOrder() {
    ...
    useEffect(() => {
        console.log("location?.state?.data?.vendorID", location?.state?.data)
        const fetchData = async () => {
            ...
            /> */}
                                ...
                                <div className="row mt-4 align-items-center">
                                    ...
                                    <div className="col-sm-6 text-sm-right text-start">
                                        ...
                                        <a href="javascript:void(0);" className="btn text-white btnColor2 ms-4 mb-2" onClick={() => navigate("/printPurchase", { state: { data, services, Address, VendorName, supplies, supplyTotalRate, serviceTotalRate } })}>
                                            Preview Print
                                        </a>
                                    </div>
                                </div>
