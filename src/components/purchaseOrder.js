...
function PurchaseOrder() {
        ...
        />
                                    ...
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <a href="javascript:void(0);" className="btn btnColor text-white mb-2" onClick={handleAddService}>
    ...
    <td className="noBorder">
        ...
        />
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <a href="javascript:void(0);" className="btn btnColor text-white mb-2" onClick={handleAddSupply}>
