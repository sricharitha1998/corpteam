            ...
            <div key={index} className="form-group mt-3">
                <div className="row">
                    <div className="col-md-4">
                        <label className='text-dark'>{input.label}</label>
                    </div>
                    ...
                    <div className="card px-5 pb-2 mb-5">
                        ...
                        {!location?.state?.id &&
                            <div className='row'>
                                ...
                                <label className='text-dark'>Work Order Number*</label>
                                    <input
                                        type="text"
                                        name="workOrderNumber"
                                        placeholder="Enter Work Order Number"
                                        className="form-control"
                                        onChange={UpdateOrderCheck}
                                        required
                                    />
                                </div>
                                <div className='col-md-5'>
                                <label className='text-dark'>Building Area*</label>
                                    <input
                                        type="text"
                                        name="buildingArea"
                                ...
                                <button type="submit" onClick={CheckWCF} className="btn btn-sm btn-primary">Check</button>
                                </div>
                            </div>
                        }
                            <br />
                            {renderFileInputs()}
                            {getShow ?
                                <button type="button" onClick={() => setShow(false)} className="btn text-primary">
                                    -
                                </button>
                                :
                            ...
                            <div className="row mt-3">
                                ...
                                <div className="col-md-4">
                                    <button type="submit" onClick={clickSubmit} className="btn btn-primary" disabled={SubmitBtn}>Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
